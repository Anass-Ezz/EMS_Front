...
function calculateAndEmitStats(actualData, forecastData) {
  ...
  emit('update-stats', {
    actualAvg: (actualAvg / 1000).toFixed(2), // Convert grams to kg
    forecastAvg: (forecastAvg / 1000).toFixed(2), // Convert grams to kg
    ...
    series: [
      {
        name: 'Actual',
        type: 'bar',
        data: chartData.value.actualData.map(val => val / 1000), // Convert grams to kg
        itemStyle: {
          color: '#ea580c'
        },
        barWidth: '40%'
      },
      {
        name: 'Forecast',
        type: 'bar',
        data: chartData.value.forecastData.map(val => val / 1000), // Convert grams to kg
        itemStyle: {
          color: '#f59e0b'
        },
        barWidth: '40%'
