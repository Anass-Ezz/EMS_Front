<template>
  ...
  const METER_CONFIG = {
    'sm-a-0': { name: 'WS-A Stamping Press', base: 420, volatility: 0.15, spiky: true },
    'sm-a-1': { name: 'WS-A Induction Heater', base: 380, volatility: 0.12, spiky: true },
    'sm-a-2': { name: 'WS-A Coil Feeder', base: 85, volatility: 0.08, spiky: false },
    'sm-a-3': { name: 'WS-A Large Welder', base: 55, volatility: 0.22, spiky: true },
    'sm-a-4': { name: 'WS-A Controls', base: 22, volatility: 0.05, spiky: false },
    'sm-a-5': { name: 'WS-A Utilities', base: 28, volatility: 0.06, spiky: false },
    'sm-b-0': { name: 'WS-B Chassis Mounting', base: 95, volatility: 0.12, spiky: true },
    'sm-b-1': { name: 'WS-B Robotic Arms', base: 88, volatility: 0.18, spiky: true },
    'sm-b-2': { name: 'WS-B Wiring Benches', base: 24, volatility: 0.05, spiky: false },
    'sm-b-3': { name: 'WS-B Control', base: 24, volatility: 0.04, spiky: false },
    'sm-b-4': { name: 'Solar Inverter (PV)', base: 140, volatility: 0.06, spiky: false }
  }
