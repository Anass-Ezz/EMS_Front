...
// All 11 meters
const meters = ref([
  { id: 'sm-a-0', name: 'Stamping Press Meter' },
  { id: 'sm-a-1', name: 'Induction Heater Meter' },
  { id: 'sm-a-2', name: 'Robotic Arms A Meter' },
  { id: 'sm-a-3', name: 'Large Welder Meter' },
  { id: 'sm-a-4', name: 'Feeder Motor Meter' },
  { id: 'sm-a-5', name: 'Workshop A Control Meter' },
  { id: 'sm-b-0', name: 'Chassis Mounting Meter' },
  { id: 'sm-b-1', name: 'Robotic Arms B Meter' },
  { id: 'sm-b-2', name: 'Wiring Benches Meter' },
  { id: 'sm-b-3', name: 'Workshop B Control Meter' },
  { id: 'sm-b-4', name: 'Solar Inverter Meter' }
])
